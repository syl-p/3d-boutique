...
export function BaseballCap(props) {
  ...
  return (
    <group {...props} dispose={null} scale={0.003} rotation={[0, - Math.PI / 0.45, 0]} position-z={0.75} position-y={0.125}>
      <group rotation={[-Math.PI / 2, 0, 0]}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          <mesh castShadow geometry={nodes.baseballCap.geometry} material={materials.baseballCap} material-color={mainColorsPalette[mainColor]} position={[0.005, -2.9, -11.842]} rotation={[-0.161, 0, 0]} scale={20.118} />
          ...
          <mesh castShadow geometry={nodes.baseballCap_2.geometry} material={materials.baseballCap} position={[0.005, -2.9, -11.842]} rotation={[-0.161, 0, 0]} scale={20.118} />
          ...
          <mesh castShadow geometry={nodes.baseballCap_3.geometry} material={materials.baseballCap} position={[0.005, -2.9, -11.842]} rotation={[-0.161, 0, 0]} scale={20.118} />
        </group>
      </group>
    </group>
  )
